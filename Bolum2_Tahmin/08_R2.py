...
print(linerReg.predict(poly.fit_transform([[10]])))

#Random Forest
from sklearn.ensemble import RandomForestRegressor

rf_reg = RandomForestRegressor(n_estimators=10 , random_state=0) #10 karar agacı

rf_reg.fit(x, y.ravel())

print("RANDOM FOREST MODELİN TAHMİNİ:")
print(linerReg.predict(poly.fit_transform([[10]])))

plt.scatter(x, y, color="blue")
plt.plot(x,rf_reg.predict(x) , color="orange")
plt.show()
...
print("Random Forest R^2 Yöntemi")
print(r2_score(y,rf_reg.predict(x)))

print("Karar Agacı R^2 Yöntemi")
print(r2_score(y,dt_reg.predict(x)))

print("SVR R^2 Yöntemi")
print(r2_score(y,svr_reg.predict(x)))

print("Polinom R^2 Yöntemi")
print(r2_score(y,linerReg.predict(poly.fit_transform(x))))
